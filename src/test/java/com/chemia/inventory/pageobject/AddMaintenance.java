...
public class AddMaintenance extends BasePage {

	ElementUtilities eUtil;
	JavaScriptUtilities js;

	public AddMaintenance(WebDriver driver) {
		super(driver);
		eUtil = new ElementUtilities(driver);
		js = new JavaScriptUtilities(driver);
	}
	
	public void setEquipmentCode(String equipmentCode) throws InterruptedException {
	...
	public void clickEquipmentCode() {
	...
	public void clickEquipmentTab() {
		WebElement element = eUtil.waitForElementPresence(By.xpath("//span[contains(text(), 'Maintenance')]"), 10);
		js.doJsClick(element);		
	}
	
	public void clickAddButton() throws InterruptedException {
		WebElement element = eUtil.waitForElementPresence(By.xpath("//mat-icon[@mattooltip='Add']"), 10);
		js.doJsClick(element);	
		Thread.sleep(2000);
		
		}
		
	public void selectMaintenanceCategory() throws InterruptedException {
		WebElement element = eUtil.waitForElementPresence(By.xpath("//p-select[@formcontrolname='equipmentMaintenanceType']"), 10);
		js.doJsClick(element);	
		
		WebElement element1 = eUtil.waitForElementPresence(By.xpath("//li[@aria-label='PARTIAL']"), 10);
